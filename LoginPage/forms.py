...
class PetAdoptionFormRequest(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = (
            ...
            'id_type',
            'id_number',
            'id_upload',  # Add the upload field to the form
        )
        widgets = {
    ...
    def clean(self):
        ...
        if id_upload and id_upload.size > 5 * 1024 * 1024:  # 5MB limit
            self.add_error('id_upload', "File size must be less than 5MB.")
